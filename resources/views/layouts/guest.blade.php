...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('app-a4e22004.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('bootstrap-5fad208b.css')}}" />
    <!--favicon-->
...
<!--End of Tawk.to Script-->
    ...
    <script src="{{asset('app-6e0eadfb.js')}}"></script>
    <script>
